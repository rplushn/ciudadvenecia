...
const projects = [
  {
    ...
    desc: 'El proyecto insignia de INMAER. Más de 250 lotes residenciales con amenidades completas, seguridad 24/7, piscinas, canchas de padel y casa club.',
    stats: [
      { number: '250+', label: 'Lotes' },
      { number: '12K', label: 'm² verdes' },
  ...
  },
  {
    ...
    title: 'Ciudad Venecia\nOlancho',
    desc: 'El proyecto más ambicioso de INMAER. Desarrollo premium en el hermoso Valle de Lepaguare con amenidades de primer nivel, piscinas y gimnasio.',
    stats: [
      { number: '10×17', label: 'Metros por lote' },
      { number: 'L.6K', label: 'Prima desde' },
    ],
    cta: 'Ver Olancho',
    ctaBg: '#E8E2D5',
    ctaColor: '#2C2C2C',
  ...
  },
  {
    ...
    title: 'Ciudad Venecia\nTalanga',
    desc: 'Nuevo lanzamiento 2026. Tres conceptos: Raíces, Estándar y Premium. Desde L.900/mes. Accesos pavimentados y financiamiento directo sin intereses.',
    stats: [
      { number: '3', label: 'Conceptos' },
      { number: 'L.900', label: 'Cuota desde' },
    ],
    cta: 'Conocer Talanga',
    ctaBg: '#EBE7DF',
    ctaColor: '#2C2C2C',
  ...
  {
    id: 'sanlorenzo',
    tag: 'A 10 min de la playa',
    location: 'Valle',
    title: 'Ciudad Venecia\nSan Lorenzo',
    desc: 'A 10 minutos de la playa. Desarrollo residencial con ubicación estratégica en el Golfo de Fonseca. Lotes desde 10×15m con financiamiento directo.',
    stats: [
      { number: '10×15', label: 'Metros por lote' },
      { number: 'L.6K', label: 'Prima desde' },
    ],
    cta: 'Ver San Lorenzo',
    ctaBg: '#D4C8B0',
