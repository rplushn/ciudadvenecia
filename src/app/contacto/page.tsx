      ...
      <main className="flex-grow flex items-center justify-center relative px-6 pt-24">
        ...
        <div className="text-center max-w-3xl mx-auto relative z-10">
            ...
            <p className="text-[#6B665F] text-lg md:text-xl font-light leading-relaxed mb-12">
                Estamos actualizando nuestros canales digitales para darte una atención más rápida y personalizada. <br className="hidden md:block"/>
                Mientras tanto, puedes usar el botón de "Contáctanos" en el menú principal.
            </p>
